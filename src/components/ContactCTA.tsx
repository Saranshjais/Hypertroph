  ...
  return (
    <section className="w-full bg-[#f2f9fd] py-16 px-4 flex justify-center overflow-hidden">
      ...
      >
        ...
        {/* Right Side: Button */}
        <div className="shrink-0 w-full md:w-auto mt-2 md:mt-0 relative z-10">
          <Link href="/apply">
            <button className="relative overflow-hidden w-full md:w-auto bg-[#044c7b] hover:bg-[#033b60] hover:-translate-y-1 active:translate-y-0 transition-all text-white font-black text-sm px-9 py-3.5 rounded shadow-[0_4px_10px_rgba(4,76,123,0.3)] hover:shadow-[0_8px_20px_rgba(4,76,123,0.5)] tracking-wider group/btn">
              ...
              <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/20 to-transparent group-hover/btn:animate-[shimmer_1s_infinite] z-0"></div>
            </button>
          </Link>
        </div>
